function figure1 = createIRfigure(cdata1, X1, Y1, X2, Y2, X3, X4, X5, cdata2, cmap, datalimits)
...
% Create image
image([-40.9819878472222-0.5 58.2682291666667-0.5],...
    [-56.5494791666667-1.2931 62.7083333333333-1.2931],cdata2,'Parent',axes2,...
    'CDataMapping','scaled');
colormap(cmap)
% Create plot
